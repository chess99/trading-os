...
#### 1. system-architect (首席技术官/系统架构师)
- **角色**: 技术领导者，负责系统架构、代码实现、技术决策
- **权限**: 完整的开发权限，可以修改代码和架构
- **技能**: fund-management + market-analysis
- **模式**: acceptEdits (自动接受编辑)
- **使用场景**: 系统开发、架构优化、Bug修复、新功能实现

#### 2. fund-manager (基金经理)
- **角色**: 投资决策者，负责投资策略和组合管理
- **权限**: 分析和决策权限
- **技能**: fund-management + market-analysis
- **模式**: acceptEdits (自动接受编辑)
- **使用场景**: 投资分析、市场研究、投资决策

#### 3. research-analyst (研究分析师)
- **角色**: 深度研究和基本面分析专家
- **权限**: 只读权限，专注分析
- **技能**: market-analysis
- **模式**: default
