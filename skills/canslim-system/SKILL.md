...
Recipe 和脚本只提供证据链、候选表和草稿。最终研究报告必须由 agent 以研究员/基金经理身份
亲自阅读 manifest、trace、候选表、单标的深研和 watchlist 后改写；不能把自动生成的
Markdown、CSV 摘要或路径清单直接交给用户冒充研究结论。
...
9. 完整复核报告完成后，再进入 watchlist、回测和风控。
